...
- **Factory Farm Confinement (>= 4 Mobs in 4x4 Area)**: Breeding in small enclosed pens or 1x1/2x2 pit holes stunts offspring size down to **0.25x scale** (yielding minimal item drops).
