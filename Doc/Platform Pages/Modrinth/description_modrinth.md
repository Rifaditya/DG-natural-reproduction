...
- **🏚️ Cramped Space Penalty vs. 🌾 Spacious Size Recovery**: Breeding in confined factory farm pens (4+ mobs in 4x4 area) stunts offspring down to `0.25x` scale. Moving animals to open pastures (+30% recovery per generation) restores physical size potential up to `1.30x`!
